...
static void InitColors(void)
{
    ...
    DefineColor("Light Gray", .9, .9, .9);
    DefineColor("White", 1, 1, 1);
    DefineColor("Brown", .35, .20, .05);
    DefineColor("Red", 1, 0, 0);
    DefineColor("Orange", 0.914, 0.545, 0.165);
    DefineColor("Yellow", 1, 1, 0);
    DefineColor("Green", 0, 1, 0);
    DefineColor("Blue", 0, 0, 1);
    DefineColor("Magenta", 1, 0, 1);
    DefineColor("Cyan", 0, 1, 1);
    DefineColor("Pink", 0.95, 0.58, 0.61);
    DefineColor("Flesh", 0.99, 0.93, 0.8);
    //Customary Colors
    DefineColor("Violet", 0.541, 0.420, 0.745);
    DefineColor("Violet1", 0.56, 0.467, 0.710);
    DefineColor("Violet2", 0.516, 0.398, 0.612);
    DefineColor("Violet3", 0.608, 0.565, 0.761);
    DefineColor("Violet4", 0.439, 0.392, 0.604);
    DefineColor("Violet5", 0.4, 0.196, 0.486);
    DefineColor("Violet6", 0.596, 0.427, 0.698);
    DefineColor("Violet7", 0.325, 0.239, 0.357);
    DefineColor("Black1", 0.9, 0.9, 0.9); 
    DefineColor("Black2", 0.8, 0.8, 0.8); 
    DefineColor("Black3", 0.7, 0.7, 0.7); 
    DefineColor("Black4", 0.5, 0.5, 0.5); 
    DefineColor("Black5", 0.4, 0.4, 0.4); 
    DefineColor("Black6", 0.3, 0.3, 0.3); 
    DefineColor("Black7", 0.2, 0.2, 0.2); 
